...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  Stream<LoginState> mapEventToState(LoginEvent event) async*{
    ...
    else if(event is LoginWithGooglePressed) yield* _mapLoginWithGooglePressedToState();
    else if(event is LoginWithFacebookPressed) yield* _mapLoginWithFacebookPressed();
