...
import 'package:flutter1_0/register_bloc/bloc.dart';
import 'package:flutter1_0/login_bloc/validators.dart';
...
class RegisterBloc extends Bloc<RegisterEvent, RegisterState> {
  ...
  @override
  Stream<RegisterState> transform(Stream<RegisterEvent> events,Stream<RegisterState> Function(RegisterEvent event) next,){
  ...
  Stream<RegisterState> mapEventToState(RegisterEvent event) async*{
    ...
    else if(event is PasswordChanged) yield* _mapPasswordChangedToState(event.password);
